...
{
    public static List<TodoistTask> FindTodosByProject(this TodoistStats todoist_stats, TodoistProject project)
    {
    ...
    public static List<CompletedTodoistTask> FindCompletedTodos(this TodoistStats todoist_stats,
